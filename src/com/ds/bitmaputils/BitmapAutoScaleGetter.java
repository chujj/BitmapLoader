...
public class BitmapAutoScaleGetter {
	private static final boolean DEBUG_PERFORMANCE = false;
	private static BitmapAutoScaleGetter sInstance;
	...
	private static synchronized BitmapAutoScaleGetter getInstance() {
		if (sInstance == null) {
			sInstance = new BitmapAutoScaleGetter();
		}
		return sInstance;
	}
	
	private Printer mTheradprint;
	private BitmapAutoScaleGetter() {
	...
	public static void releaseBitmap(BitmapTask aTask) {
		BitmapAutoScaleGetter instance = getInstance();
